    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <h1>
                    <asp:Label ID="lblReloj" runat="server" Text="" Font-Size="X-Large" ForeColor="#0066FF"></asp:Label>
                </h1>
            </ContentTemplate>
        </asp:UpdatePanel>
        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:GridView ID="gvDoctores" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ShowFooter="True" AutoGenerateColumns="False" DataKeyNames="Id_Doctor,Id_Sexo_Doctor,Id_Intervencion_Doctor,Id_Turno_Doctor" OnRowCancelingEdit="gvDoctores_RowCancelingEdit" OnRowDeleting="gvDoctores_RowDeleting" OnRowEditing="gvDoctores_RowEditing" OnRowUpdating="gvDoctores_RowUpdating" AllowSorting="True" OnPageIndexChanging="gvDoctores_PageIndexChanging" PageSize="5" OnSorting="gvDoctores_Sorting" AllowPaging="True">
                    <Columns>
                        <asp:TemplateField HeaderText="[Nombre]" SortExpression="Nombre_Doctor">
                            <EditItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="[Turno]" SortExpression="Nombre_Turno">
                            <EditItemTemplate>
